 ...
 *
 */
public class CubeRoot extends javax.swing.JFrame {

    /**
     * Creates new form CubeRoot
     */
    public CubeRoot() {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("CubeRoot Function: f(x) = 3√x");
...
double i, x, y;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CubeRoot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
