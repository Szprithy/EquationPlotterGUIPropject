 ...
 *
 */
public class Cosx extends javax.swing.JFrame {

    /**
     * Creates new form Cosx
     */
    public Cosx() {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cosine Function: f(x) = cosx");
        ...
        jSpinner1.setBounds(430, 700, 60, 50);
...
double i, x, y;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cosx.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
