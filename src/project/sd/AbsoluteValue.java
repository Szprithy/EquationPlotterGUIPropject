 ...
 *
 */
public class AbsoluteValue extends javax.swing.JFrame {

    /**
     * Creates new form AbsoluteValue
     */
   ...
   public class XYLineChart_AWT extends ApplicationFrame
    ...
    private void initComponents() {
        ...
        jSpinner1.setBounds(430, 700, 70, 60);
        ...
        jSpinner2.setBounds(730, 700, 70, 60);
        ...
        jButton1.setBounds(1270, 730, 73, 23);

        jLabel6.setFont(new java.awt.Font("Telenor", 1, 36)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Absolute Value Function: f(x) = |x|");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(400, 50, 660, 90);
...
new Options().setVisible (true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbsoluteValue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbsoluteValue().setVisible(true);
            }
        });
    }
